...
description: Fix janky animation perf (layout, compositor, scroll).
...
metadata:
  hermes:
    tags: [ui, motion, performance, frontend]
    related_skills: [ui-animations, ui-components, ui-foundations]
---
