...
description: Audit and fix HTML accessibility (ARIA, focus, contrast).
author: ibelick (ui-skills), Hermes Agent
license: MIT
version: 0.1.0
platforms: [linux, macos, windows]
metadata:
  hermes:
    tags: [ui, accessibility, a11y, frontend]
    related_skills: [ui-checklist, ui-components, ui-foundations]
---
