---
name: wizard
description: Generate a bash wizard for manual steps only a human can do.
version: 1.0.0
...
metadata:
  hermes:
    tags: [wizard, provisioning, credentials, ci-secrets, bash, onboarding]
    related_skills: [native-project-deployment, pre-commit-security-hook]
---
