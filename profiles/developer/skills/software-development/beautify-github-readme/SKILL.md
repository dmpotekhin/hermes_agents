...
Based on [oil-oil/beautify-github-readme](https://github.com/oil-oil/beautify-github-readme) (MIT license).
...
- For a GitHub URL, inspect the current remote page and default branch before proposing changes. Use `gh repo view` or `web_extract` / `browser_navigate` to fetch the repository homepage.
