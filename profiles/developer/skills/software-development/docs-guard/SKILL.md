---
name: docs-guard
description: Verify docs claims against the codebase before shipping.
...
metadata:
  hermes:
    tags: [quality, docs, code-review, guard]
    related_skills: [requesting-code-review, verification-before-completion, github-pages]
---
