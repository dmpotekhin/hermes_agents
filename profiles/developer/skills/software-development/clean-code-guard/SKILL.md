...
description: Review code before it ships: clean code + AI failure modes.
author: Hermes Agent (adapted from amElnagdy/guard-skills)
license: MIT
version: 1.0.0
platforms: [macos, linux, windows]
metadata:
  hermes:
    tags: [quality, code-review, clean-code, guard]
    related_skills: [security-review, requesting-code-review, two-axis-code-review, verification-before-completion]
---
